...
namespace Report_screen_shots.advertiser
{
    class Xertive
    {
        ...
        public Xertive(string path, string url, string advertiser)
        {
        ...
        public void Get_reports_screen_shots(IWebDriver driver, Report_data report)
        {
            ...
            try
            {
                ...
                Thread.Sleep(2000);
                //  wait.Until(element => element.FindElement(By.Id("button-1052-btnIconEl"))).Click();
                ...
                run_report.Click();
                Thread.Sleep(10000);
                wait.Until(element => element.FindElement(By.Id("panel-1069_header_hd-textEl"))).Click();
                Thread.Sleep(5000);
